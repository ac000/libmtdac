...
int mtd_init_auth(void)
{
	...
	args[0] = "xdg-open";
	args[1] = "https://test-www.tax.service.gov.uk/oauth/authorize?response_type=code&client_id=TlQLDx2MSRpl6KAkgVeL4CaeXkAa&scope=write:self-assessment+read:self-assessment&redirect_uri=urn:ietf:wg:oauth:2.0:oob";
