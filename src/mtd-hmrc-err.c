...
static const struct {
	...
	ERR_MAP_ENT(CLIENT_NOT_MTD_ENROLLED),
	...
	ERR_MAP_ENT(DUPLICATE_PROPERTY_ID),
	...
	ERR_MAP_ENT(FORMAT_CONTRACTOR_NAME),
	...
	ERR_MAP_ENT(FORMAT_PREFERENCE_ORDER),
	ERR_MAP_ENT(FORMAT_PROPERTY_ID),
	...
	ERR_MAP_ENT(RULE_ACCOUNTING_PERIOD_NOT_ALIGNED),
	...
	ERR_MAP_ENT(RULE_CARRY_BACK_CLAIM),
	ERR_MAP_ENT(RULE_CARRY_FORWARD_AND_TERMINAL_LOSS_NOT_ALLOWED),
	...
	ERR_MAP_ENT(RULE_DISPOSAL_DATE_FUTURE),
	...
	ERR_MAP_ENT(RULE_GIFT_AID_NON_UK_AMOUNT_WITHOUT_NAMES),
	ERR_MAP_ENT(RULE_GIFTS_NON_UK_AMOUNT_WITHOUT_NAMES),
	...
	ERR_MAP_ENT(RULE_INCORRECT_NON_STANDARD_GAINS),
	...
	ERR_MAP_ENT(RULE_MISSING_PREFERENCE_ORDER),
	...
	ERR_MAP_ENT(RULE_OVERLAP_RELIEF_USED_NOT_ALLOWED),
	ERR_MAP_ENT(RULE_PERIODS_OF_ACCOUNT),
	ERR_MAP_ENT(RULE_PREFERENCE_ORDER_NOT_ALLOWED),
	ERR_MAP_ENT(RULE_PREMATURE_FINALISATION),
	ERR_MAP_ENT(RULE_PROPERTY_ID_MISMATCH),
	...
	ERR_MAP_ENT(RULE_TAX_DEDUCTION_NOT_ALLOWED),
	ERR_MAP_ENT(RULE_TAX_YEAR_FOR_VERSION_NOT_SUPPORTED),
