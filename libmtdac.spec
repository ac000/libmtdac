...
- Update to version 3.0 of 'Individuals Capital Gains Income' API
- New HMRC error codes
- Update to some Property Business endpoints
...
- Build with -funsigned-char
- Many fixes

* Tue Mar 03 2026 Andrew Clayton <ac@sigsegv.uk> - 1.5.3-1
- Minor fixes

* Thu Feb 19 2026 Andrew Clayton <ac@sigsegv.uk> - 1.5.2-1
- Add support for the Individuals Capital Gains Income & Individuals Reliefs
  APIs

* Fri Oct 31 2025 Andrew Clayton <ac@sigsegv.uk> - 1.5.1-1
- Fix the MTD_API_EP_OB_GET_FDO endpoint
...
- Add support for more endpoints; Individuals Other Income,
  Individuals Foreign Income, CIS Deductions &
